...
export const Header = () => {
    ...
    return (
        <header className={`"w-full p-5 flex flex-col space-y-5 ${namePage == "/" ? "bg-[url(/bg.jpg)] min-h-dvh bg-[]" : "bg-blue-950 bg-cover bg-center"}`}>
            ...
            {namePage === "/" && (
                <form className=" w-1/2 p-5 space-y-2 ring-1 ring-white rounded-md m-5">
                    ...
                    <div className="w-full flex flex-col">
                        ...
                        <input type="text" name="ingredient" id="ingredient" className="bg-white p-2 rounded-md outline border-none" placeholder="ej:vodka, whisky" value={searchRecipe.ingredient}/>
                    </div>

                    <div className="w-full flex flex-col">
                        <label htmlFor="category" className="capitalize text-white text-xl cursor-pointer">categoria</label>
                        <select name="category" id="category" className="bg-white p-2 rounded-md outline border-none cursor-pointer" onChange={e=>}>
